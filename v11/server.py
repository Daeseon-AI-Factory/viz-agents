...
viz_kind 가이드 (작업 종류에 따라 다르게):
  ...
  - whatif : ★ V11 핵심 — 현재 vs 변경 후 예측 비교
             viz_data: {"title": "...", "current": [{"k": "...", "v": "..."}], "after": [{"k": "...", "v": "...", "change": "good|bad|neutral"}], "recommendation": "..."}
...
- code는 100줄 이내
- ★ V11 우선: 변경 작업이면 "현재 vs 변경 후" 영향 예측. viz_kind "table" 로 before/after 비교.
- JSON 외 다른 텍스트, 마크다운, 코드펜스 절대 금지
"""

app = FastAPI(title="VIZ V11 Live HUD")
