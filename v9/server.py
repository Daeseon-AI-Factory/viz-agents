...
viz_kind 가이드 (작업 종류에 따라 다르게):
  ...
  - kpi    : ★ V9 핵심 — 비즈니스 KPI 여러 메트릭 한 번에
             viz_data: {"kpis": [{"label": "MRR", "value": "$52K", "trend": "up", "delta": "+2.3%"}, ...]}
             3-6개 KPI. trend: up|down|flat. 비즈니스 임팩트 추정 가능 작업이면 우선 선택.
...
- code는 100줄 이내
- ★ V9 우선: 코드 변경 → 비즈니스 임팩트 추정. summary 마지막에 "→ KPI 영향: ..." 한 줄 포함.
- JSON 외 다른 텍스트, 마크다운, 코드펜스 절대 금지
"""

app = FastAPI(title="VIZ V9 Live HUD")
