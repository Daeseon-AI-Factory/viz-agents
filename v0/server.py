"""VIZ V0 — Claude Code Live HUD server.

Receives hook events via POST /event, broadcasts to browser via WebSocket /ws.
...
app = FastAPI(title="VIZ V0 Live HUD")
...
async def health() -> dict[str, Any]:
    return {"ok": True, "clients": len(_clients), "events": len(_history)}
